        ...
        <section class="perfil">
          ...
          <div class="galeria">
            ...
            <div class="galeria__foto-principal">
              <img src={require("../resources/images/galeria1.jpg")} />
            </div>
            <div class="galeria__fotos-adicionales">
              <img
                src={require("../resources/images/galeria2.jpg")}
                width="160"
              />
              <img src={require("../resources/images/galeria3.jpg")} />
              <img src={require("../resources/images/galeria4.jpg")} />
            </div>
          </div>
        </section>
